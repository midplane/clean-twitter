...
Working and in daily use, but not packaged for the extension stores. Before a
store release it still needs real icons (the current ones are the WXT
placeholder), a licence, and a published privacy policy covering the data flow
described above.
